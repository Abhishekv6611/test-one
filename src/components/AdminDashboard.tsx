  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <Badge className="ml-3 bg-purple-600/80 text-purple-100">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 w-64 bg-white/10 border-white/20 text-white placeholder:text-gray-300 focus:bg-white/20"
                />
              </div>
              <ThemeToggle />
              <div className="flex items-center">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Projects Grid */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-gray-900 mb-4">All Projects</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {allProjects.map((project, idx) => {
              ...
              return (
                <Card 
                  key={project.name} 
                  className="bg-white cursor-pointer hover:shadow-lg transition-all duration-200 border border-gray-200 hover:border-purple-300"
                >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {Object.entries(projectModules).map(([module, count]) => (
                              <Badge key={module} className={getModuleColor(module)} style={{ fontSize: '10px', padding: '2px 6px' }}>
                                {getModuleIcon(module)}
                                <span className="ml-1">{formatModuleDisplay(module)}: {count}</span>
                              </Badge>
                            ))}
                          </div>
                        </div>
                      ...
                      {projectTickets.length > 0 && (
                        <div className="space-y-2">
                          ...
                          {projectTickets.slice(0, 2).map((ticket) => (
                            <div key={ticket.id} className="flex items-center justify-between p-2 bg-gray-50 rounded border">
