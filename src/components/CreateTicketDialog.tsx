...
const CreateTicketDialog = ({ open, onClose, onSubmit }: CreateTicketDialogProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!title.trim() || !description.trim() || !module) return;
    ...
    onSubmit({ 
      ...
      priority,
      module,
      subModule: module === 'integrations' ? subModule : undefined
    });
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="module">Module/Category</Label>
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            <Button 
              type="submit" 
              disabled={!title.trim() || !description.trim() || !module || (module === 'integrations' && !subModule)}
            >
              Create Ticket
            </Button>
          </div>
